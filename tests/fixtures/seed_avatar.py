...
def seed_other_avatar():
    ...
    pytest.other_avatar = services.AvatarService().create(s3_filename=s3_filename)
    services.MemberService().apply(instance=pytest.other_member, avatar=pytest.other_avatar)
